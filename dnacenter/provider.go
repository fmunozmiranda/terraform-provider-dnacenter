...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"dnacenter_discovery_id_job":                               dataSourceDiscoveryIDJob(),
			...
			"dnacenter_compliance_device_list_details":                 dataSourceComplianceDeviceListDetails(),
			"dnacenter_compliance_device_details":                      dataSourceComplianceDeviceDetails(),
			"dnacenter_compliance_device_list":                         dataSourceComplianceDeviceList(),
