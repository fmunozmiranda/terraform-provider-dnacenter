...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"dnacenter_snmpv3_credential":                              dataSourceSNMPv3Credential(),
			"dnacenter_snmpv2_write_community_credential":              dataSourceSNMPv2WriteCommunityCredential(),
			"dnacenter_snmpv2_read_community_credential":               dataSourceSNMPv2ReadCommunityCredential(),
			"dnacenter_netconf_credential":                             dataSourceNetconfCredential(),
			"dnacenter_http_write_credential":                          dataSourceHTTPWriteCredential(),
			"dnacenter_http_read_credential":                           dataSourceHTTPReadCredential(),
			"dnacenter_cli_credential":                                 dataSourceCliCredential(),
